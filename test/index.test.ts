...
describe('ua-platformer', function () {
  describe('#getPlatformName', function () {
    it('should return the proper name of a given platform', function () {
      expect(getPlatformName('alamofire')).to.equal('Swift');
    });

    it('should capitalize the name of an unknown platform', function () {
  ...
  describe('main', function () {
    ...
    describe('should detect known platforms', function () {
      Object.entries({
    ...
    describe('should detect browser platforms', function () {
      Object.entries({
        Chrome: [
